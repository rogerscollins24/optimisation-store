...
def seed_if_empty(db: Session) -> None:
    ...
    users = [
        User(username="john_doe", email="john@example.com", phone="+1234567890", login_password="pass123", withdraw_password="wd123", balance=500.00, vip_level=2, invite_code="INV000001", status="Active", role=UserRole.MERCHANT),
        User(username="jane_smith", email="jane@example.com", phone="+0987654321", login_password="pass456", withdraw_password="wd456", balance=1250.00, vip_level=4, invite_code="INV000002", status="Active", role=UserRole.SUPER_ADMIN),
    ]
    db.add_all(users)
    db.flush()
